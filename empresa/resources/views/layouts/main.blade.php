...
<html lang="en">
    <head>
        ...
        <meta name="description" content="@yield('description', 'Blog sobre dispositivos')" />
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{ url('/') }}">Mi Empresa</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        {{-- Usamos url() para generar las rutas dinámicamente --}}
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ url('contact') }}">Contact</a></li>
                         @if (Route::has('login'))
                            @auth
                                <li class="nav-item"><a href="{{ url('/home') }}" class="nav-link px-lg-3 py-3 py-lg-4">Dashboard</a></li>
                            @else
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('@yield('header-image', asset('assets/img/home-bg.jpg'))')">
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; Mi Empresa 2023</div>
                    </div>
                </div>
            </div>
        </footer>
